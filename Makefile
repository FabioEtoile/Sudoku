...
### REGLE POUR GENERER LA JAVADOC ###

JAVADOC = javadoc
JAVADOCFLAGS = -encoding UTF-8 -d JavaDoc -sourcepath .

javadoc :
	${JAVADOC} ${JAVADOCFLAGS} $(shell find . -name "*.java")
...
### BUTS FACTICES ###
.PHONY : run1 run2 clean mrproper all
